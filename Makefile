SHELL := /bin/bash
.PHONY: help test test-short test-file test-watch lint vet build build-linux install check prepare push release clean
...
help:
	...
	@echo "  clean         - clean-up files generated by release"
